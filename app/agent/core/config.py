...
class AgentSettings(BaseSettings):
    ...
    schema_cache_ttl_seconds: int = 300 # مدة صلاحية الكاش بالثواني (هنا 300 ثانية = 5 دقائق).
    retrieval_cache_ttl_seconds: int = 300 # مدة صلاحية الكاش بالثواني (هنا 300 ثانية = 5 دقائق).
